...
export async function processBulkExportItem(exportId, itemId, industryId, month, year, filters, access) {
...
export async function generateBulkZip(exportRecord, results) {
    const zip = new JSZip();
    const monthLabel = [
...
export async function generateBulkConsolidatedPdf(exportRecord, results) {
