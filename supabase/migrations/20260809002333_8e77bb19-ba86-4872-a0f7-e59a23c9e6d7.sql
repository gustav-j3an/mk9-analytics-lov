CREATE TABLE IF NOT EXISTS public.mk9_checklist_import_store_snapshots (
...
CREATE INDEX IF NOT EXISTS mk9_checklist_import_store_snapshots_import_idx ON public.mk9_checklist_import_store_snapshots (import_id);
CREATE INDEX IF NOT EXISTS mk9_checklist_import_store_snapshots_store_idx ON public.mk9_checklist_import_store_snapshots (store_id);
